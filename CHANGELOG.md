...
### Fixed
- Enabling Lua API in the Config Builder now fills in the real addon/config/output root paths instead of leaving them as placeholder text, which previously exported a config missing those keys entirely.
